...
#----Download .vcf file for genome version Wm82.a2.v1 and Wm82.a1.v1------------
options(timeout = 200)
...
# a1.v1
download.file(url = "https://soybase.org/snps/soysnp50k_wm82.a1_41317.vcf.gz",
              destfile = here("data", "snp_positions_a1.v1.vcf.gz"))
system2("cat", "data/snp_positions_a1.v1.vcf.gz | zcat | grep -v '^##' | cut -f1-3", 
        stdout = "data/snp_positions_a1.v1.txt")
system2("rm", "data/snp_positions_a1.v1.vcf.gz")
